...
*/
console.log(createMenuItem('Cafe Latte', '4', 'Drinks'));
console.log(createMenuItem('Steak and Cheese', '6', 'Lunch'))
console.log(createMenuItem('Crispy Shrimp', '8', 'Dinner'))
...
export const burger = {
  ...
  discount:function(str){
    ...
    if(str==='teacher'||str==='student'){
      result=this.price * 0.75
    } else{
      result=this.price * 0.90
    }
    return result;
  }
}
...
*/
reviews.push({name: "Brit", rating: 4.5, feedback: "Had a great Lunch!"})
console.log (reviews);
...
function getLastReview(arr) {
  ...
  return getReviewByIndex(arr, lastIndex);
} 
